...
namespace NationalInstruments.ReferenceDesignLibraries.SA
{
    public static class RFmxWLAN
    {
        ...
        {
            /// <summary>Specifies the signal under analysis as defined under IEEE Standard 802.11.</summary>
            public RFmxWlanMXStandard Standard;
            /// <summary>Specifies the channel bandwidth in Hz.</summary>
        ...
        {
            /// <summary>Specifies whether to enable averaging for the TXP measurement.</summary>
            public RFmxWlanMXTxpAveragingEnabled AveragingEnabled;
            /// <summary>Specifies the number of acquisitions used for averaging, when you set the <see cref="AveragingEnabled"/> parameter to True.</summary>
            public int AveragingCount;
            /// <summary>Specifies the maximum measurement interval in seconds.</summary>
        ...
        {
            /// <summary>Specifies the average power of the acquired signal. This value is expressed in dBm.</summary>
            public double AveragePowerMean_dBm;
            /// <summary>Specifies the peak power of the acquired signal. This value is expressed in dBm.</summary>
        ...
        {
            /// <summary>Specifies the length of the waveform to be acquired in seconds.</summary>
            public double AcquisitionLength_s;
            /// <summary>Specifies the number of data symbols to be ignored from the start of the data field for EVM computation. This value is expressed as a number of symbols.</summary>
            public int MeasurementOffset_sym;
            /// <summary>Specifies the maximum number of OFDM symbols that the measurement uses to compute EVM. This value is expressed as a number of symbols.</summary>
            public int MaximumMeasurementLength_sym;
            /// <summary>Specifies whether to optimize the analyzer's dynamic range for the EVM measurement. </summary>
            public RFmxWlanMXOfdmModAccOptimizeDynamicRangeForEvmEnabled OptimizeDynamicRangeForEvmEnabled;
            /// <summary>Specifies the margin above the reference level you specify when you set <see cref="OptimizeDynamicRangeForEvmEnabled"/> to True. This value is expressed in dB.</summary>
            public double OptimizeDynamicRangeForEVMMargin_dB;
            /// <summary>Specifies whether to enable averaging for OFDMModAcc measurements.</summary>
            public RFmxWlanMXOfdmModAccAveragingEnabled AveragingEnabled;
            /// <summary>Specifies the number of acquisitions used for averaging, when you set <see cref="AveragingEnabled"/> to True.</summary>
            public int AveragingCount;
        ...
        {
            /// <summary>Specifies the RMS EVM of all subcarriers in all OFDM symbols. This value is expressed in dB.</summary>
            public double CompositeRMSEVMMean_dB;
            /// <summary>Specifies the RMS EVM of data-subcarriers in all OFDM symbols. This value is expressed in dB.</summary>
            public double CompositeDataRMSEVMMean_dB;
            /// <summary>Specifies the RMS EVM of pilot-subcarriers in all OFDM symbols. This value is expressed in dB.</summary>
        ...
        {
            /// <summary>Specifies whether the sweep time for the SEM measurement is computed automatically by the measurement or is configured manually.</summary>
            ...
            /// This property is ignored when <see cref="SweepTimeAuto"/> is True.</summary>
            public double SweepTime_s;
            /// <summary>Specifies whether the frequency range of the spectrum used for the SEM measurement is computed automatically by the measurement or manually.</summary>
            ...
            /// This parameter is applicable only when you set <see cref="SpanAuto"/> to False.</summary>
        ...
        public struct SEMResults
        {
            ...
            /// <summary>Specifies the average power of the carrier channel over the bandwidth indicated by the SEM Carrier IBW property. This value is expressed in dBm.</summary>
            public double AbsolutePower_dBm;
            /// <summary>Specifies the average power of the carrier channel, relative to the peak power of the carrier channel, over the bandwidth indicated by the SEM Carrier IBW property.</summary>
            public double RelativePower_dB;

            /// <summary>Specifies the upper (positive) offset segment measurement status, indicating whether the spectrum exceeds the SEM measurement mask limits in the upper offset segments.</summary>
            ...
            /// Margin is defined as the maximum difference between the spectrum and the mask.</summary>
            public double[] UpperOffsetMargin_dB;
            /// <summary>Specifies the array of frequencies corresponding to the margins for the upper (positive) offsets.</summary>
            public double[] UpperOffsetMarginFrequency_Hz;
            /// <summary>Specifies the array of absolute powers corresponding to the margins for the upper offsets. This value is expressed in dBm.</summary>
            ...
            /// relative to the peak power of the carrier channel.This value is expressed in dB.</summary>
            public double[] UpperOffsetMarginRelativePower_dB;

            /// <summary>Specifies the array of lower (negative) offset segment measurement status, indicating whether the spectrum exceeds the SEM measurement mask limits in the lower offset segments.</summary>
            ...
            /// <summary>Specifies the array of frequencies corresponding to the margins for the lower (negative) offsets.</summary>
            public double[] LowerOffsetMarginFrequency_Hz;
            /// <summary>Specifies the array of absolute powers corresponding to the margins for the lower offsets. This value is expressed in dBm.</summary>
        ...
        /// fetching of multiple measurement results and traces.</param>
        ...
        /// <param name="selectorString">(Optional) Specifies the result name.</param>
        /// <returns></returns>
